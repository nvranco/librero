...
_PROMPT = (
    ...
    "Un lomo o tapa fisica es UN SOLO libro, sin importar cuantos textos "
    "distintos tenga escritos encima. Es comun que un tomo de una coleccion "
    "tenga, todos en el mismo lomo, el nombre de la coleccion, un numero de "
    "tomo o volumen, Y el titulo especifico de ese libro (ej: \"Biblioteca "
    "Basica Universal\", \"Tomo 1\", \"Crimen y castigo\"). Eso NUNCA son "
    "libros distintos — es un unico libro, y tiene que aparecer una sola vez "
    "en \"libros\". Nunca generes mas de una entrada por cada lomo o tapa "
    "fisica distinta que veas en la foto. Cuando un lomo tenga varios textos "
    "asi superpuestos, elegi como titulo_detectado el mas especifico (el "
    "titulo real de la obra, no el nombre de la coleccion ni el numero de "
    "tomo solo) — los demas textos (coleccion, tomo) se descartan, no se "
    "reportan como libros aparte.\n\n"
